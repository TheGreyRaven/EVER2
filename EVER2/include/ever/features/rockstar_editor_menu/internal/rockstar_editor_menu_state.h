...
extern std::shared_ptr<PLH::x64Detour> g_prepare_clip_detour;
extern std::shared_ptr<PLH::x64Detour> g_move_clip_detour;
extern std::shared_ptr<PLH::x64Detour> g_save_project_detour;
extern std::shared_ptr<PLH::x64Detour> g_project_start_load_detour;

extern PrepareStagingClipByIndexFn g_prepare_clip_original;
...
extern bool g_last_save_spinner_preference;
